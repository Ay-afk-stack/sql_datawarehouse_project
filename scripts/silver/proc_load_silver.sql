...
BEGIN
        ...
        BEGIN
            ...
            CAST(prd_start_dt AS DATE) AS prd_start_dt, -- Data Transformation using CAST() method
            ...
            CASE WHEN sls_ship_dt = 0
                ...
                ELSE ((sls_ship_dt::VARCHAR)::DATE)  -- Tried a new way and it worked WEW :)!!!
            END AS sls_ship_dt,
            ...
            CASE WHEN sls_price IS NULL
                OR sls_price <= 0
                THEN ABS(sls_sales) / ABS(NULLIF(sls_quantity,0))
                ELSE sls_price
            END AS sls_price
            ...
            EXCEPTION 
                WHEN OTHERS 
                THEN RAISE EXCEPTION '>>> Failed Loading crm Tables...';
        ...
        BEGIN
            ...
            EXCEPTION
                WHEN OTHERS 
                THEN RAISE EXCEPTION '>>>Failed Loading ERP Table...';
        END;
